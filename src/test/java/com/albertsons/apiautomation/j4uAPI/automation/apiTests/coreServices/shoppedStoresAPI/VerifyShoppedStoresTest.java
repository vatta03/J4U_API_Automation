package com.albertsons.apiautomation.j4uAPI.automation.apiTests.coreServices.shoppedStoresAPI;
 ...
 * Service: Shopped Stores
 * Method: GET
 */
public class VerifyShoppedStoresTest extends ConfigTestBase {
    ...
    @Test
    public void VerifyShoppedStoresTest() throws Exception {
        ...
        while (testScriptIterator.hasNext()) {
            ...
            if (globalConstants.currentTSDataRowJSONObj.get("execute").toString().equalsIgnoreCase("yes")) {
                ...
                //Step 5: Verify Shopped Stores
                appGeneric.assignDetails("Verify Shopped Stores in the Service Response", "Correct should displayed in the GET Response: " + responseDetails, "In Correct details is displayed in the GET Response" + responseDetails);
                Assert.assertTrue(responseDetails.contains("storeid"), "In Correct Store Id is displayed in the GET Response" + responseDetails);
                appGeneric.generateExtentReport(GlobalConstants.ReportStatus.PASS.toString(), testScriptName);

                //Step 5: Get Headers from the Response
                responseHeaders = getCallWrapper.getAllHeaders(restAssuredObj.baseURI, headersParams, GlobalConstants.GetCallArgs.HEADERPARAM.toString());
