package com.albertsons.apiautomation.j4uAPI.automation.apiTests.myList.myListWebAPI;
...
/**
 * Created by CSC
 * Service: My List Web Service
 * Method: GET
 */
public class VerifyMyListWebServiceTest extends ConfigTestBase {
    ...
    @Test
    public void VerifyMyListWebServiceTest () throws Exception {
        ...
        while (testScriptIterator.hasNext()){
            ...
            if(globalConstants.currentTSDataRowJSONObj.get("execute").toString().equalsIgnoreCase("yes")){
                ...
                //Step 2:
                //Call My List web Service and verifying status code
                ...
                //Step 3: Verify My List web Service Type is in JSON format
                ...
                //Step 4:
                //Get My List web Service
                appGeneric.assignDetails("GET My List web Service", "My List web Service are Extracted from GET Response-" + responseDetails, "Unable to Extract My List from Web Service from the GET Response");
                appGeneric.generateExtentReport(GlobalConstants.ReportStatus.PASS.toString(), testScriptName);
