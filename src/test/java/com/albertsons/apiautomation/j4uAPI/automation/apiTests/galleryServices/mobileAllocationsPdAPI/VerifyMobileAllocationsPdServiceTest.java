package com.albertsons.apiautomation.j4uAPI.automation.apiTests.galleryServices.mobileAllocationsPdAPI;
 ...
 * Service: Mobile Allocations pd
 * Method: GET
 */
public class VerifyMobileAllocationsPdServiceTest extends ConfigTestBase {
    ...
    @Test
    public void VerifyMobileAllocationsPdServiceTest () throws Exception {
        ...
        while (testScriptIterator.hasNext()){
            ...
            if(globalConstants.currentTSDataRowJSONObj.get("execute").toString().equalsIgnoreCase("yes")){
                ...
                appGeneric.assignDetails("Verify Service Response", "Correct details should be displayed in the GET Response: " + responseDetails, "In Correct details is displayed in the GET Response" + responseDetails);
                Assert.assertTrue(responseDetails.contains("personalizedDeals"),"In Correct Store Id is displayed in the GET Response" + responseDetails);
                appGeneric.generateExtentReport(GlobalConstants.ReportStatus.PASS.toString(), testScriptName);
