...
import com.albertsons.apiautomation.apiTestFramework.common.POSTCallWrapper;
...
/**
 * Created by Kiran on 9/4/2017.
 */
public class VerifyPostCallTest extends ConfigTestBase {

    public GETCallWrapper getCallWrapper = null;
    public POSTCallWrapper postCallWrapper = null;
    ...
    public void initializeDataExtractor(String apiGroupName,String currentAPIName) throws Exception {
        ...
        postCallWrapper = new POSTCallWrapper();
    ...
    @Test
    public void VerifyPostCallTest () throws Exception {
        ...
        while (testScriptIterator.hasNext()){
            ...
            if(globalConstants.currentTSDataRowJSONObj.get("execute").toString().equalsIgnoreCase("yes")){
                ...
                queryParams.put("title",globalConstants.currentTSDataRowJSONObj.get("title").toString());
                queryParams.put("author",globalConstants.currentTSDataRowJSONObj.get("author").toString());
                ...
                Response response = postCallWrapper.performPostCall(restAssuredObj.baseURI,queryParams);
...
//                Assert.assertTrue(responseDetails.get,"Response Content Type is not JSON" );
//                appGeneric.generateExtentReport(GlobalConstants.ReportStatus.PASS.toString(), testScriptName);
//
//                //Step 4:
